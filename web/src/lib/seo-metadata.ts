...
export function generateMetadata({
  ...
  const fullTitle =
    title.includes('PickAFarm') ||
    title.includes('Pick A Farm') ||
    title.includes(' Near ') ||
    title.includes('Farms') ||
    title.includes('Orchards')
      ? title
      : `${title} | PickAFarm`;
...
export function generateHomepageMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      'Discover the best pick-your-own farms, Christmas tree farms, and u-pick locations across Canada. Fresh produce, family activities, and seasonal fun await!',
    keywords: [
