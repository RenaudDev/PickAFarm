...
export function generateOrganizationSchema() {
  return {
    ...
    description:
      'Discover the best pick-your-own farms, Christmas tree farms, pumpkin patches, and agritourism experiences across North America. Find local farms near you for fresh produce, seasonal activities, and family fun.',
    foundingDate: '2024',
    sameAs: [
...
export function generateWebSiteSchema() {
  return {
    ...
    url: BASE_URL,
    description:
      'Find local pick-your-own farms, Christmas tree farms, and agricultural experiences',
    publisher: {
      '@id': `${BASE_URL}/#organization`,
    },
    potentialAction: {
