...
export async function generateMetadata(): Promise<Metadata> {
  return createMetadata({
    title: 'Cookie Policy - PickAFarm',
    description:
      'Learn about how PickAFarm uses cookies and similar technologies to improve your browsing experience.',
    keywords: ['cookie policy', 'cookies', 'website tracking', 'privacy'],
    url: 'https://pickafarm.com/cookies/',
  });
}
    ...
    >
      <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                location for farm searches and display preferences.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            We may use third-party services like Google Analytics to help us understand website
            usage. These services may place their own cookies on your device. Please refer to their
