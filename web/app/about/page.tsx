...
export const metadata = {
  ...
  description:
    'Connecting families with local farms for authentic agricultural experiences across Ontario and beyond.',
  alternates: {
      ...
      <div className="space-y-8">
        <Card>
          <CardContent className="p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              PickAFarm is dedicated to connecting families and individuals with local farms,
              creating meaningful connections between urban communities and agricultural heritage.
              We believe that visiting farms provides educational opportunities, supports local
              agriculture, and creates lasting memories for families.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Our comprehensive directory features hundreds of farms across Ontario, offering
                everything from pick-your-own experiences to educational tours, seasonal events, and
                fresh produce sales.
              </p>
        ...
        <Card>
          <CardContent className="p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We help farm owners connect with their communities by providing a platform to showcase
              their offerings, share their stories, and attract visitors. Our verified listings
              ensure quality experiences while supporting local agricultural businesses.
            </p>
          </CardContent>
        </Card>
